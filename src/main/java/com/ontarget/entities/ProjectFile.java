...
public class ProjectFile implements Serializable {
    ...
    private List<ProjectFilePage> projectFilePage;
    ...
    public List<ProjectFilePage> getProjectFilePage() {
        return projectFilePage;
    }

    public void setProjectFilePage(List<ProjectFilePage> projectFilePage) {
        this.projectFilePage = projectFilePage;
    }
}
