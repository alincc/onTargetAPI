...
public class TaskCommentNotificationMessage extends NotificationMessageComposer {
	private User user;
	...
	public void composeMessage() {
		...
		String messageTemplate = notificationTemplateConfig.getTaskCommentTemplate();
