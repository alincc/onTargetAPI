...
public class CompanyDAOImpl implements CompanyDAO {
	...
	public int addCompanyInfo(Company company) throws Exception {
		...
		jdbcTemplate.update(new PreparedStatementCreator() {
			public PreparedStatement createPreparedStatement(Connection connection) throws SQLException {
				PreparedStatement ps = connection.prepareStatement(OnTargetQuery.CREATE_COMPANY, new String[] { "id" });
	...
	public Company getCompany(int companyId) throws Exception {
		return jdbcTemplate.queryForObject(OnTargetQuery.GET_COMPANY, new Object[] { companyId }, new RowMapper<Company>() {
			@Override
