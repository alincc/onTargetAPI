...
public class AuthenticationDAOImpl implements AuthenticationDAO {
	...
	@Override
	public List<RegistrationRequestDTO> getUserRegistrationPendingRequests()
			throws Exception {
		...
		jdbcTemplate.query(OnTargetQuery.GET_USER_REGISTRATION_PENDING_REQUEST,
				new Object[] {}, new RowMapper<RegistrationRequestDTO>() {
					@Override
					public RegistrationRequestDTO mapRow(ResultSet resultSet,
	...
	public boolean approvePendingRegistrationRequest(
			RegistrationApprovalRequest req) throws Exception {
	...
	@Override
	public boolean createUser(RegistrationApprovalRequest request)
			throws Exception {
		int row = jdbcTemplate.update(
	...
	@Override
	public UserDTO getUserSignInInfo(SignInRequest signInRequest)
			throws Exception {
		...
		jdbcTemplate.query(OnTargetQuery.USER_LOGIN,
				new Object[] { signInRequest.getUsername() },
