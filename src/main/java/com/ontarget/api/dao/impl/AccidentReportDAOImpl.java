...
public class AccidentReportDAOImpl extends BaseGenericDAOImpl<AccidentReport> implements AccidentReportDAO {
	...
	public AccidentReport insert(AccidentReport accidentReport) {
		...
		accidentReport.setAccidentReportId(kh.getKey().longValue());
	...
	public boolean update(AccidentReport accidentReport) {
		int count = jdbcTemplate.update(OnTargetQuery.accidentReport.UPDATE, 
				...
				accidentReport.getWitness(),
				accidentReport.getLocation(),
				accidentReport.getBriefOfAccident(),
				accidentReport.getSeverity(),
				accidentReport.getDescription(),
