...
public class UserInvitationTest extends BaseTest {
	...
	//
	// UserInvitationRequest userInvitationRequest = new
	...
	// userInvitationRequest.setCompanyId(0);
	...
	// userInvitationRequest.setCompanyTypeId(1);
	//
	// System.out.println("Client request.... \n");
	// System.out.println(toJsonString(userInvitationRequest, true));
	// Response response = sendRequest("/onTargetInvitation/inviteToNewAccount",
	// userInvitationRequest);
...
//		System.out.println("Client request.... \n");
//		Response response = sendRequest("/onTargetInvitation/approvalRequest?id=3", "");
//		if (response.getStatus() != 200) {
...
//	}
	...
	// System.out.println("Client request.... \n");
	// Response response =
	// getRequest("/onTargetInvitation/validateLink?q=289491604971351964613053906223968544910802334885836803590542");
	// if (response.getStatus() != 200) {
	// throw new RuntimeException("Failed : HTTP error code : "
	// + response.getStatus());
	// }
