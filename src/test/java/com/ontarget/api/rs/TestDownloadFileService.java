...
public class TestDownloadFileService {
	...
	public static final String DOWNLOAD_FILE_LOCATION = "/home/santosh/excel/download/";

	public static void main(String[] args) throws IOException {

		String httpURL = "http://localhost:8080/ontargetrs/services/file/download/excel";
	...
	public static String testDownloadService(String httpURL) throws IOException {
		...
		try {
			...
			client.property("accept", "application/vnd.ms-excel");
			webTarget = client.target(httpURL);

			// invoke service
			invocationBuilder = webTarget.request();
			// invocationBuilder.header("Authorization", "Basic " +
			// authorization);
			...
			qualifiedDownloadFilePath = DOWNLOAD_FILE_LOCATION + "MyJerseyExcelFile.xlsx";
