...
FOR EACH ROW BEGIN
  INSERT INTO activity_log (text, category) VALUES
    (CONCAT("Task ", NEW.dependent_task_id, " is made dependent on task ", NEW.task_id, " by user ", NEW.created_by),
     11);
  INSERT INTO user_notification (text, user_id, category) VALUES
    (CONCAT("Task ", NEW.dependent_task_id, " is made dependent on task ", NEW.task_id, " by user ", NEW.created_by),
     NEW.created_by, 11);
...
FOR EACH ROW BEGIN
  ...
  VALUES (CONCAT("New planned cost added for task ", NEW.task_id, " by user ", NEW.created_by), 6);
  INSERT INTO user_notification (text, user_id, category)
  VALUES (CONCAT("New planned cost added for task ", " by ", NEW.created_by, NEW.task_id), NEW.created_by, 6);
END$$
DELIMITER ;
...
FOR EACH ROW BEGIN
  INSERT INTO activity_log (text, category)
  VALUES (CONCAT("planned cost updated for task ", NEW.task_id, " by user ", NEW.modified_by), 7);
  INSERT INTO user_notification (text, user_id, category)
  VALUES (CONCAT("planned cost updated for task ", NEW.task_id, " by ", NEW.modified_by), NEW.modified_by, 7);
END$$
DELIMITER ;
...
FOR EACH ROW BEGIN
  INSERT INTO activity_log (text, category) VALUES
    (CONCAT("New project ", NEW.project_id, " of type", New.project_category_id, " added by ", NEW.project_owner_id),
     2);
  INSERT INTO user_notification (text, user_id, category) VALUES
    (CONCAT("New project ", NEW.project_id, " of type", New.project_category_id, " added by ", NEW.project_owner_id),
     NEW.project_owner_id, 2);
END$$
DELIMITER ;
...
FOR EACH ROW BEGIN
  INSERT INTO activity_log (text, category)
  VALUES (CONCAT("New member ", NEW.user_id, " added for project ", NEW.project_id), 8);
  INSERT INTO user_notification (text, user_id, category)
  VALUES (CONCAT("New member ", NEW.user_id, " added for project ", NEW.project_id), NEW.user_id, 8);
END$$
DELIMITER ;
...
FOR EACH ROW BEGIN
  INSERT INTO activity_log (text, category) VALUES
    (CONCAT("New file ", NEW.file_name, " uploaded for task ", NEW.project_task_id, " by user ", NEW.created_by), 10);
  INSERT INTO user_notification (text, user_id, category) VALUES
    (CONCAT("New file ", NEW.file_name, " uploaded for task ", NEW.project_task_id, " by user ", NEW.created_by),
     NEW.created_by, 10);
END$$
DELIMITER ;
...
FOR EACH ROW BEGIN
  INSERT INTO activity_log (text, category)
  VALUES (CONCAT("project ", NEW.project_id, " updated by ", NEW.modified_by), 3);
  INSERT INTO user_notification (text, user_id, category)
  VALUES (CONCAT("project ", NEW.project_id, " updated by ", NEW.modified_by), NEW.modified_by, 3);
END$$
DELIMITER ;
...
FOR EACH ROW BEGIN
  INSERT INTO activity_log (text, category)
  VALUES (CONCAT("New task ", NEW.title, " of id ", New.project_task_id, " added by ", NEW.created_by), 4);
  INSERT INTO user_notification (text, user_id, category) VALUES
    (CONCAT("New task ", NEW.title, " of id ", New.project_task_id, " added by ", NEW.created_by), NEW.created_by, 4);
END$$
DELIMITER ;
...
FOR EACH ROW BEGIN
  INSERT INTO activity_log (text, category)
  VALUES (CONCAT("New assignee ", NEW.task_assignee, " added for task ", NEW.project_task_id), 9);
  INSERT INTO user_notification (text, user_id, category)
  VALUES (CONCAT("New assignee ", NEW.task_assignee, " added for task ", NEW.task_assignee), NEW.task_assignee, 9);
END$$
DELIMITER ;
...
FOR EACH ROW BEGIN
  INSERT INTO activity_log (text, category)
  VALUES (CONCAT("task ", NEW.title, " of id ", New.project_task_id, " updated by ", NEW.modified_by), 5);
  INSERT INTO user_notification (text, user_id, category) VALUES
    (CONCAT("task ", NEW.title, " of id ", New.project_task_id, " updated by ", NEW.modified_by), NEW.created_by, 5);
END$$
DELIMITER ;
