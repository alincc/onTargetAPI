...
profile
 */
insert into `profile` (`profile_id`, `active`, `added_date`, `modified_date`, `name`, `added_by`, `modified_by`, `description`, `profile_code`)
values('1','Y','2015-08-23 17:27:48',NULL,'Super User','1',NULL,'Super User Profile','SU');
insert into `profile` (`profile_id`, `active`, `added_date`, `modified_date`, `name`, `added_by`, `modified_by`, `description`, `profile_code`)
values('2','Y','2015-08-23 17:28:09',NULL,'Project Manager','1',NULL,'Project Manager Profile','PM');
insert into `profile` (`profile_id`, `active`, `added_date`, `modified_date`, `name`, `added_by`, `modified_by`, `description`, `profile_code`)
values('3','Y','2015-08-23 17:28:27',NULL,'Regular User','1',NULL,'Regular User','RU');

/*
featured mapped request
 */
insert into `feature_request_mapper` (`feature_request_mapper_id`, `has_feature`, `request_path`, `application_feature_id`)
values('1','Y','/task/getTaskDetail','2');
...
insert into `profile_menu` (`profile_menu_id`, `active`, `application_menu_id`, `profile_id`) values('8','Y','1','2');
insert into `profile_menu` (`profile_menu_id`, `active`, `application_menu_id`, `profile_id`) values('9','Y','2','2');
insert into `profile_menu` (`profile_menu_id`, `active`, `application_menu_id`, `profile_id`) values('10','Y','3','2');
insert into `profile_menu` (`profile_menu_id`, `active`, `application_menu_id`, `profile_id`) values('11','Y','4','2');
insert into `profile_menu` (`profile_menu_id`, `active`, `application_menu_id`, `profile_id`) values('12','Y','6','2');
insert into `profile_menu` (`profile_menu_id`, `active`, `application_menu_id`, `profile_id`) values('13','Y','7','2');
insert into `profile_menu` (`profile_menu_id`, `active`, `application_menu_id`, `profile_id`) values('14','Y','1','3');
insert into `profile_menu` (`profile_menu_id`, `active`, `application_menu_id`, `profile_id`) values('15','Y','2','3');
insert into `profile_menu` (`profile_menu_id`, `active`, `application_menu_id`, `profile_id`) values('16','Y','3','3');
insert into `profile_menu` (`profile_menu_id`, `active`, `application_menu_id`, `profile_id`) values('17','Y','7','3');
...
/*
user profile change the user id profile assignment.
 */
